...
![](images/512px-2023_Obsidian_logo.svg.png){height="250" fig-align="center"}
...
::: {.notes}
- Documentation: revealing links between topics/projects/people
:::
...
**Software fundamentals + software management**

- Make informed decisions
- Solve (small) issues
- Acknowledge open-source

![](images/logos.png){height="350" fig-align="center"}
...
(infrastructure) software as components
...
- software components: UI, server, database, Python
